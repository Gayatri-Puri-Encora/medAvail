...
//Get newly created patient
  ...
  function storePatientDetails(){
    ...
    Project.Variables.patientFirstName= jsonResponseBody.name.firstName;
    Log.Message(Project.Variables.patientFirstName);
    Project.Variables.patientLastName= jsonResponseBody.name.lastName;
    Log.Message(Project.Variables.patientLastName);
    Project.Variables.patientDateOfBirth= jsonResponseBody.dateOfBirth;
    Log.Message(Project.Variables.patientDateOfBirth);
  }
